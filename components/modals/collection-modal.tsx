...
function CollectionModalComponent({ isOpen, onClose, creativeId }: CollectionModalProps) {
      ...
      <Card className="w-full max-w-md">
        <CardContent className="p-6">
          ...
          <div className="p-4 space-y-4">
            <div>
              <label htmlFor="new-collection-name" className="text-sm text-slate-600 mb-2 block">
            ...
            <div>
              <div className="text-sm text-slate-600 mb-2 block">Your collections</div>
...
export const CollectionModal = memo(CollectionModalComponent);
