...
const newsItems = [
  ...
  },
  {
    ...
    content: "Apple unveils next-generation iPhone with enhanced AI capabilities and breakthrough performance features",
    category: "Hardware",
  ...
  },
  {
    ...
    content: "AI search company raises massive funding round, valuation soars as competition with Google intensifies",
    category: "Funding",
...
export function AINewsModal({ isOpen, onClose, processingMessage }: AINewsModalProps) {
        ...
        <CardContent className="p-0">
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm">{processingMessage || "Working on your request..."}</p>
                </div>
              </div>
          ...
          <div className="px-6 py-4 border-b border-slate-200">
            <div className="flex items-center space-x-2 mb-3">
              ...
              <span className="text-sm text-slate-600 font-medium">AI is working on your request...</span>
            </div>
              ...
              <div className={`${currentNews.bgColor} rounded-2xl p-6 border border-slate-200`}>
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <h5 className="text-lg font-semibold text-slate-900 mb-2 leading-tight">{currentNews.title}</h5>
              ...
              {newsItems.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${
                    index === currentNewsIndex ? "bg-blue-500 scale-125 shadow-lg" : "bg-slate-300 hover:bg-slate-400"
                  }`}
