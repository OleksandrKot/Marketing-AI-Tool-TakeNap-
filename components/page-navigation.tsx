  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      <div
        ...
        role="menu"
        aria-hidden={!open}
        className={`md:hidden absolute left-2 top-12 w-56 bg-white border border-slate-200 rounded-xl shadow-lg z-50 transform transition-all duration-150 origin-top ${
          open
