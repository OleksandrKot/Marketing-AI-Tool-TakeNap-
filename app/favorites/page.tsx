            ...
            <div className="container mx-auto px-6 py-12 max-w-7xl">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
                    ...
                    <div className="flex items-center gap-3 mt-4 md:mt-0">
                        ...
                        <label className="inline-block">
                            ...
                            />
                            <Button variant="outline" className="bg-white">Import Collection</Button>
                        </label>
                        <Button
                            variant="ghost"
                ...
                <div className="mb-8 bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
                    <p className="text-slate-600">
                        <span className="font-semibold text-slate-900">{filteredFavorites.length}</span> of {favorites.length} saved creatives
                    ...
                    <div className={viewMode === 'grid' ?
                        ...
                        {filteredFavorites.map((f) => {
                            ...
                            return viewMode === 'grid' ? (
                                ...
                                >
                                    <CardHeader className="p-6 pb-4 flex flex-row items-start justify-between">
                                        <div className="flex-1 min-w-0">
                                            <h3 className="font-medium text-slate-900 truncate text-lg leading-tight mb-1">{truncateText(ad?.title, 35)}</h3>
                                    ...
                                    <CardFooter className="p-6 pt-0 flex items-center justify-between mt-4">
                                        <Link href={`/creative/${f.creativeId}`}>
                                            <Button variant="outline" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl h-11 transition-all duration-200 hover:shadow-md hover:shadow-blue-500/25">
                                                View Details
                                            </Button>
                                        </Link>
                                        <Button
                                ...
                                <Card key={f.creativeId} className="bg-white border border-slate-200 rounded-2xl h-full overflow-hidden hover:shadow-md transition-shadow duration-200">
